...
namespace ToDoGrpc.Services
{
    public class ToDoService: ToDoIt.ToDoItBase
    {
        ...
        {
            if (request.Id <= 0)
                throw new RpcException(new Status(StatusCode.InvalidArgument, "resource index must be greater then 0"));
            ...
            throw new RpcException(new Status(StatusCode.NotFound, $"No Task with id : {request.Id} is found"));
        }
